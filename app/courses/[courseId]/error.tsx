...
export default function Error({
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-2xl font-bold text-gray-800">Couldn&apos;t load this course</h1>
        <p className="text-gray-600 text-sm">Something went wrong fetching your course data. Try again or head back to the dashboard.</p>
        <button
          onClick={reset}
